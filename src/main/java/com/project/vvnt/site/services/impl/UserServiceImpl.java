package com.project.vvnt.site.services.impl;
...
import com.project.vvnt.site.exceptions.ResourceNotFoundException;
import com.project.vvnt.site.helper.Helper;
...
//        pageNumber default starts from 0
    ...
    public PageableResponse<UserDto> searchUser(String keyword,int pageNumber,int pageSize, String sortBy,String sortDir) {
        ...
        PageableResponse<UserDto> pageableResponse = Helper.getPageableResponse(users, UserDto.class);
